                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="orange">
                                    <h4 class="title">Hasil Inspeksi Perbulan</h4>
                                ...
                                <div class="card-content table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $dataBerkala = mysqli_query($conn, "SELECT form_teknisi.no_form, tanggal,nip, no_tangki, status FROM form_teknisi JOIN hasil_form_teknisi ON form_teknisi.no_form = hasil_form_teknisi.no_form WHERE form_teknisi.jenis = 'Bulanan' GROUP BY ABS(SUBSTRING(form_teknisi.no_form,4,LENGTH(form_teknisi.no_form))) DESC HAVING COUNT(*) > 1");
