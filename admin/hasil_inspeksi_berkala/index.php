                                ...
                                <div class="card-content table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $dataBerkala = mysqli_query($conn, "SELECT form_teknisi.no_form, tanggal FROM form_teknisi JOIN hasil_form_teknisi ON form_teknisi.no_form = hasil_form_teknisi.no_form WHERE form_teknisi.jenis = 'Berkala' GROUP BY ABS(SUBSTRING(form_teknisi.no_form,4,LENGTH(form_teknisi.no_form))) ASC HAVING COUNT(*) > 1");
